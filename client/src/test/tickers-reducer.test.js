import {setTickersAC, tickersReducer} from "../state/tickers-reducer";
...
test('tickers should be added correct', () => {
    let startState = [];

    const action = setTickersAC(serverResponse);

    const endState = tickersReducer(startState, action)
